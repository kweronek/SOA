...
func Home(w http.ResponseWriter, r *http.Request) {
	...
	default:
		...
		//		w.Header().Add(
//			"link",
//			"rel='icon' type='image/x-icon' href='../viewResource/favicon.ico'",
//		) //		<link rel="icon" type="image/x-icon" href="./favicon.ico" />
//		if err != nil {
//			log.Print("Unable to set header")
//			return
//		}
...
func FaviconHandleFunc(w http.ResponseWriter, r *http.Request) {
	log.Println("FaviconHandleFunc:")
	log.Printf("%s %s %s %s\n", r.Method, r.Host+r.URL.Path, r.Proto, r.Header["Content-Type"])
	w.Header().Set("Content-Type", "image/x-icon")
	w.Header().Set("Cache-Control", "public, max-age=10")

	http.ServeFile(	w, r, "../viewResource/favicon.ico")
}
